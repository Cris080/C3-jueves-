...
puts(cad2);
cad2[10] = "Guatemala"; /* Incorrecto. Observa cuidadosamente el caso anterior y analiza la diferenciaque existe con éste.
Aquí se produce un error en la compilación del programa, al tratar de asignar la cadena de caracteres ”Guatemala” al caracter 11 de la cadena. */
}
