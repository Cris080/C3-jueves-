...
void Imprime(int A[], int T)  /* Esta función se utiliza para escribir un arreglo unidimensional
...
void Ordena(int A[], int T)   /* La función Ordena utiliza el método de selección directa para ordenar
