...
elementos de tipo entero. */
    ...
    float Media(int A[], int T)  /* Esta función se utiliza para calcular la media. */
    {
        int I;
        float SUM = 0.0;
        for (I=0; I < T; I++)
    ...
    float varianza(int A[], int T, float M)  /* Esta función se utiliza para calcular la varianza. */
    {
        int I;
        float SUM = 0.0;
        for (I=0; I < T; I++)
    ...
    float Desviacion (float V)  /* Esta función se utiliza para calcular la desviación estándar. */
    {
        return (sqrt(V));
    }

    void Frecuencia(int A[], int P, int B[])  /* Esta función se utiliza para calcular la frecuencia de calificaciones.*/
        int I;
        for (I=0; I < P; I++)
        B[A[I]]++;
    }
