...
correspondientes para resolver el problema. */
{
        ...
        switch (I%3)
    {
        ...
        break;
        defaul: B[I] = Mod0 (A,I, N);
        break;
    }
}

float Mod0 (int A[][10], int K, int M) /* Esta función calcula el cociente entre una productoria y una sumatoria. */
{
    int I;
...
float Mod2 (int A[][10], int N, int M) /* Esta función obtiene el resultado de la productoria. */
{
    int I;
    float PRO = 1.0;
    for (I=N; I<M; I++)
