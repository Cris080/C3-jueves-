...
/* Esta función se utiliza para modificar el promedio de un alumno. */
{
    int d;
    alumno alu;
    printf("\nIngrese el numero de registros que desea modificar: "); /* Observa que el lenguaje C almacena el primer registro en la posición cero.
    Por lo tanto, si desea modificar el registro n, debe buscarlo en la posición n-1. */
    scanf("%d", &d);
