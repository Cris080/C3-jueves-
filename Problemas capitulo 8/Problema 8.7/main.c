...
/* Esta función se utiliza para leer la información de un arreglo unidimensional de tipo estructura alumno
de T elementos. */
{
    int I, J;
    for(I=0; I<T; I++)
...
/* Esta función se utiliza para obtener las matrículas de los alumnos cuya calificación en
